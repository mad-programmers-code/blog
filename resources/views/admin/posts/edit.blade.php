...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.posts.update", [$post->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="main_content">{{ trans('cruds.post.fields.main_content') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('main_content') ? 'is-invalid' : '' }}" name="main_content" id="main_content">{!! old('main_content', $post->main_content) !!}</textarea>
                @if($errors->has('main_content'))
                    <div class="invalid-feedback">
                        {{ $errors->first('main_content') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.post.fields.main_content_helper') }}</span>
            </div>
            <div class="form-group">
